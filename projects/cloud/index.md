...
Welcome to my cloud portfolio. Below are selected architecture case studies demonstrating enterprise modernization, cloud-native transformation, secure cloud design, high availability, hybrid infrastructure, and scalable deployments across AWS.
...
- [Scalable and Highly Available Web Application for Café](/projects/cloud/cafe-autoscaling/)
  ...
  **Skills:** EC2 Auto Scaling, Application Load Balancer, Launch Templates, CloudWatch, Systems Manager
...
- [Highly Available Web Application on AWS](/projects/cloud/high-availability-app/)
  ...
  **Skills:** AWS VPC, EC2, Auto Scaling, Application Load Balancer, RDS, Security Groups
